...
export default function LearnerDashboard() {
  ...
  const fetchEnrolled = async () => {
    const res = await fetch('https://modular-learning-platform.onrender.com/api/courses/enrolled/me', {
  ...
  const handleEnroll = async (courseId) => {
    const res = await fetch(`https://modular-learning-platform.onrender.com/api/courses/${courseId}/enroll`, {
      method: 'POST',
      headers: {
