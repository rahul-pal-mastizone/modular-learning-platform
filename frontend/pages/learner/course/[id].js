...
export default function CoursePage() {
  ...
  const fetchCourse = async () => {
    const res = await fetch(`https://modular-learning-platform.onrender.com/api/courses/${id}/full`, {
  ...
  const handleSubmit = async () => {
    ...
    const res = await fetch(`https://modular-learning-platform.onrender.com/api/courses/${id}/progress/complete`, {
      method: 'POST',
      headers: {
